...
import IVRAccessNumbersStore from 'stores/IVRAccessNumbers'
import CustomTable, {
    ...
    },
    {
      ...
      getCellData: row => (
        <Typography
          ...
          onClick={() =>
            history.push(
              `/customers/${customerId}/subaccounts/${groupId}/ans_instances/ivr/${
      ...
      <Paper className={classes.paper}>
        {isConfiguredNumbersLoading && !numberLike ? (
          ...
          <CustomTable
            ...
            tableId={'ans_ivr_access_numbers'}
